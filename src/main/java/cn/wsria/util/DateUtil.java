...
//		java.sql.Date testDate = java.sql.Date.valueOf("2009-12-12");
		...
		java.sql.Date d3 = java.sql.Date.valueOf("2009-12-16");
		java.sql.Date d4 = java.sql.Date.valueOf("2009-12-19");
...
//		java.sql.Date d7 = java.sql.Date.valueOf("2009-12-23");
		...
		dates.add(d6);
		dates.add(d7);
		List<List<? extends java.util.Date>> groupDates = groupDates(dates);
		for (List<? extends java.util.Date> date : groupDates) {
			System.out.println(date);
		}*/
		List<java.sql.Date[]> dates = new ArrayList<java.sql.Date[]>();
		dates.add(new java.sql.Date[] {d1, d2});
		dates.add(new java.sql.Date[] {d3, d4});
		List<java.sql.Date> allDate = getAllDate(dates);
